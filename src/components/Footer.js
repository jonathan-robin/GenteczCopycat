...
<div class='lg:flex lg:justify-center'>
            <div class='h-16 justify-center flex lg:-mt-9'>
                <img src={Gentecz} class='h-16 align-baseline px-6 pt-5 pb-4 lg:h-20'/> 
            </div>

<div class='lg:flex'>
    <div class='lg:row'>
            <div class='text-white font-bold font-title ml-4 mb-2 lg:mr-24'>SERVICES</div>
    ...
    <div class='lg:row'>
            <div class='text-white font-bold font-title ml-4 mt-8 mb-2 lg:mt-0 lg:mr-24'>RESOURCE</div>
            ...
            <div class='lg:row'>
            <div class='text-white font-bold font-title ml-4 mt-8 mb-2 lg:mt-0'>HELP</div>
